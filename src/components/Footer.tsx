...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border bg-muted/30 animate-fade-in">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          {/* Brand Column */}
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4 group">
              <img src={logo} alt="AppMaster" className="h-8 w-auto group-hover:scale-105 transition-transform" />
            </Link>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link to="#" className="text-sm text-muted-foreground hover:text-primary hover:underline transition-all">
                Privacy Policy
              </Link>
              <Link to="#" className="text-sm text-muted-foreground hover:text-primary hover:underline transition-all">
                Terms of Service
